...
from .views import CeldaListCreateAPIView, CeldaDetailAPIView, celdas_view, crear_celda_view, detalle_celda
...
urlpatterns = [
    ...
    path('detalle/<int:celda_id>/', detalle_celda, name='detalle_celda'),
]